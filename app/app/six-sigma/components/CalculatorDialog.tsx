...
export default function CalculatorDialog({ sheet, onApply, onClose }: Props) {
  ...
  return (
    /* Ventana flotante, no modal: la calculadora se usa mirando los datos, asi
       que tapar la rejilla con un velo era justo lo contrario de lo util. */
    <div
      ref={boxRef}
      style={style}
      className="fixed z-[100] w-[42rem] max-w-[calc(100vw-2rem)] rounded-lg border border-gray-300 bg-white shadow-2xl"
      onKeyDown={(e) => {
