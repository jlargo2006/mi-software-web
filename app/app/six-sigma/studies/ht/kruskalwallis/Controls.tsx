// app/app/six-sigma/studies/ht/kruskalwallis/Controls.tsx
"use client";
import React from "react";
import type { ColumnInfo } from "../../../lib/columns";
import type { HTKruskalWallisParams } from "./types";
...
export default function HTKruskalWallisControls({
  params,
  onChange,
  columns,
}: {
  params: HTKruskalWallisParams;
  onChange: (p: HTKruskalWallisParams) => void;
  columns: ColumnInfo[];
}) {
  const set = <K extends keyof HTKruskalWallisParams>(
    k: K,
    v: HTKruskalWallisParams[K]
  ) => onChange({ ...params, [k]: v });
